                    ...
                    <div className="lg:flex lg:items-center lg:-mx-10">
                        <div className="lg:w-1/2 lg:mx-10">
                            ...
                            <form className="mt-12" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <input type="submit" value="get in touch" className="w-1/2 px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-orange-500 rounded-md hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50" />
                            </form>
                        </div>

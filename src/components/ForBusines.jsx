              ...
              <form className="mt-12" onSubmit={handleSubmit(onSubmit)}>
                <div className="flex-1 px-2">
                  ...
                  <input
                    ...
                    className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-600 bg-white border border-gray-200 rounded-md dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-orange-600 dark:focus:border-orange-600 focus:ring-orange-600 focus:outline-none focus:ring focus:ring-opacity-40"
                  />
                ...
                <div className="flex-1 px-2">
                  ...
                  <div className=" flex justify-center items-center gap-1">
                    <PhoneInput
                      ...
                      onChange={setValue}
                      placeholder={+91}
                      className="block w-24 py-2 mt-2 focus:border-orange-600 dark:focus:border-orange-600 focus:ring-orange-600 focus:outline-none focus:ring focus:ring-opacity-40"
                    />
                    <input
                      type="number"
                ...
                <div className="w-full mt-2">
                  ...
                  <textarea
                    className="block w-full h-16 px-5 py-3 mt-2 text-gray-700 placeholder-gray-600 bg-white border border-gray-200 rounded-md md:h-56 dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-orange-600 dark:focus:border-orange-600 focus:ring-orange-600 focus:outline-none focus:ring focus:ring-opacity-40"
                    placeholder="Message"
                  ></textarea>
                </div>
            ...
            <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
              ...
              {/* <div className="mt-6 w-80 md:mt-8">
                                ...
                                <div className="flex mt-4 -mx-1.5 ">
                                    <a className="mx-1.5 dark:hover:text-orange-600 text-gray-600 transition-colors duration-300 transform hover:text-orange-500" href="#">

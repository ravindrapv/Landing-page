            ...
            <div className="lg:w-1/2 lg:mx-10">
              ...
              <form className="mt-12" onSubmit={handleSubmit(onSubmit)}>
                ...
                <input
                  type="submit"
                  value="get in touch"
                  className=" w-1/2 items-center px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-orange-500 rounded-md hover:bg-orange-400 focus:outline-none focus:ring focus:ring-orange-300 focus:ring-opacity-50"
                />
              </form>
            </div>
            ...
            <div className="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
              ...
              {/* <div className="mt-6 w-80 md:mt-8">
                                ...
                                <div className="flex mt-4 -mx-1.5 ">
                                    <a className="mx-1.5 dark:hover:text-orange-400 text-gray-400 transition-colors duration-300 transform hover:text-orange-500" href="#">

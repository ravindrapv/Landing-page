            ...
            <section className="text-gray-700" id="ContactUs">
                <div className="container px-5 py-4 mx-auto">
                    <div className=' text-center my-8'>
                        <h1 className="text-3xl font-semibold text-blue-900 capitalize lg:text-4xl dark:text-white">Contact us</h1>
                        <div className="mt-2">
                    ...
                    <div>
                        <Box sx={{ width: "100%" }}>
                            <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
                                ...
                                >
                                    <Tab label="For Busines" {...a11yProps(0)} sx={{ fontWeight: 'bold', textTransform: 'capitalize', color: '#F6762A' }} />
                                    <Tab label="For Interviwer" {...a11yProps(1)} sx={{ fontWeight: 'bold', textTransform: 'capitalize', color: '#F6762A' }} />
                                </Tabs>
                            </Box>
